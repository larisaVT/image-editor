...
if __name__=='__main__':
    #Factory.register('default_fonts', '/home/stefan/Desktop/repo/gallery/fonts/fonts/Material-Design-Iconic-Font.ttf', join(dirname(__file__), '/home/stefan/Desktop/repo/gallery/fonts/fonts/zmd.fontd'))
    GalleryApp().run()